...
public class BusLogAspect {
    ...
    private void recordLog(Method method, Object[] arguments, String[] params) {
        ...
        try {
            businessLogMapper.insert(createBusinessLog(actionType, oprNo, referId, userId, oprTableName, extend,
                    traceId));
        } catch (Exception e) {
    ...
    private cn.seed.log.entity.BusinessLog createBusinessLog(int actionType, String optNo, String referId, String
            userId, String oprTableName, String extend, String traceId) {
