...
public class SignUtils {
     ...
     * @author 方典典
     * @time 2019/5/15 10:09
     */
    public static String sign(String strText) {
        return Base64Utils.encryptBASE64(EncryptUtils.encrypt(SECRET + strText + SECRET, "MD5"));
    }
